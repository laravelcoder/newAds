    ...
    public function show($id)
    {
        ...
        $created_by_teams = \App\Team::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');$contacts = \App\Contact::where('company_id', $id)->get();$categories = \App\Category::whereHas('advertiser_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$phones = \App\Phone::where('advertisers_id', $id)->get();$audiences = \App\Audience::where('advertiser_id', $id)->get();$demographics = \App\Demographic::where('advertiser_id', $id)->get();$ads = \App\Ad::where('advertiser_id', $id)->get();$contacts = \App\Contact::whereHas('adverstiser_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
        ...
        return view('admin.contact_companies.show', compact('contact_company', 'contacts', 'categories', 'phones', 'audiences', 'demographics', 'ads', 'contacts', 'agents'));
    }

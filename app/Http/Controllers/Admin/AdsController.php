    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $table->editColumn('video_upload', function ($row) {
                if ($row->video_upload) {
                    return '<a href="'.asset(env('UPLOAD_PATH').'/'.$row->video_upload).'" target="_blank">Download file</a>';
                }
            });
            ...
            $table->editColumn('video_screenshot', function ($row) {
                if ($row->video_screenshot) {
                    return '<a href="'.asset(env('UPLOAD_PATH').'/'.$row->video_screenshot).'" target="_blank"><img src="'.asset(env('UPLOAD_PATH').'/thumb/'.$row->video_screenshot).'"/>';
                }
            });

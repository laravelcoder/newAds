...
<li role="presentation" class="active"><a href="#audiences" aria-controls="audiences" role="tab" data-toggle="tab">Audiences</a></li>
...
<div role="tabpanel" class="tab-pane active" id="audiences">

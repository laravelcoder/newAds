...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.report_settings.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('show_clip_button', 1, old('show_clip_button', true), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('show_group_button', 1, old('show_group_button', true), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('show_live_button', 1, old('show_live_button', true), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('enable_evt_timing', 1, old('enable_evt_timing', false), []) !!}

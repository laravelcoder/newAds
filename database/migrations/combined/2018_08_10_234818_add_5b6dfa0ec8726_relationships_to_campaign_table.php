...
class Add5b6dfa0ec8726RelationshipsToCampaignTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('campaigns', function (Blueprint $table) {
            if (Schema::hasColumn('campaigns', 'created_by_id')) {
                $table->dropForeign('178203_5b33e3653c258');
                $table->dropIndex('178203_5b33e3653c258');
                $table->dropColumn('created_by_id');
            }
            if (Schema::hasColumn('campaigns', 'created_by_team_id')) {
                $table->dropForeign('178203_5b33e365545f3');
                $table->dropIndex('178203_5b33e365545f3');
